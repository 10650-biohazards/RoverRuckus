...
@Autonomous(name = "Depot Close Park", group = "Depot Start")
public class depot_auto_close extends ExplosiveAuto {
    ...
    public void body() {
        ...
        if (left){
            ...
            drive.move_straight_PID(2150, 5000);
            drive.move_turn_gyro(0);
            drive.move_straight_PID(-1450);
            drive.move_turn_gyro(270);
            drive.move_straight_PID(500);
        } else if (center) {
            ...
            drive.move_straight_PID(2250);
            drive.move_turn_gyro(225);
            drive.move_straight_PID(250);
            drive.move_turn_gyro(270);
        } else {
